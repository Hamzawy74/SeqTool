...
with st.container():
    ...
    with left_column:
        ...
        st.write(
            ...
            - Specify the Sequencing company
            - Make Sure the File is a FASTQ format
...
with st.container():
    ...
    st.subheader("Use Our Tool Below")
with st.form("my_form"):
   ...
   adapter_type = st.selectbox('Kindly Choose the Sequencing Compnay', ['illumina', 'TruSeq','Nextra'])

   # Every form must have a submit button.
   submitted = st.form_submit_button("Process!")
   if submitted:
       st.write("URL Accessability: ", url_access, ",Adapter Type: ", adapter_type)  
